  ...
  <v-container>
    ...
    >
      ...
      <svg
        ...
        height="80"
        viewBox="0 0 250 250"
        style="fill:#151513; color:#fff; position: absolute; bottom: 0; border: 0; left: 0; transform: scale(-1, 1);"
        aria-hidden="true"
        rot
      >
    ...
    <v-row align="center" justify="center" style="height: 60%;">
        <v-col v-for="(step, index) in downloadSteps" :key="index" :cols="downloadSteps.length">
    ...
    <v-row align="center" justify="center">
      <v-col>
        <div class="faq text-center pt-8">
          <h1 style="color: accent">Get all the help you need</h1>
        </div>
      </v-col>
    </v-row>
    <v-spacer />
...
import { IHelpItems, HelpItems } from "@/config/litterals/help";
...
export default class Help extends Vue {
  helpItems: IHelpItems[] = HelpItems;
  githubLink = "https://github.com/groCervo/Youtube-downloader";
  downloadSteps = [
      {
          title: "downloadSteps.firstTitle",
          content: "downloadSteps.firstContent"
      },
      {
          title: "downloadSteps.secondTitle",
          content: "downloadSteps.secondContent"
      },
      {
          title: "downloadSteps.thirdTitle",
          content: "downloadSteps.thirdContent"
      },
  ];  
